...
public class VerifyRegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String enteredOTP = request.getParameter("otpInput");
        String expectedOTP = request.getParameter("otp");
        ...
        if (enteredOTP.equals(expectedOTP)) {
            ...
            boolean registrationSuccess = accountDAO.createAccount(account);
